package com.console.service.client;
 ...
 * A Decorator of DefaultMQAdminExt
 * MQAdminInstance.threadLocalMQAdminExt() of DefaultMQAdminExt（MQAdminAspect Manage link/interrupt）
 * Manage link is lucency for invoker
 */
@Service
